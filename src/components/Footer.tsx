  ...
  return (
    <footer id="site-footer">
      <div class="footer-aurora" aria-hidden="true">
        <span class="footer-aurora__glow footer-aurora__glow--royal"></span>
        <span class="footer-aurora__glow footer-aurora__glow--sky"></span>
        <span class="footer-aurora__glow footer-aurora__glow--gold"></span>
      </div>

      <div class="footer-shell" id="company-section">
        <div class="footer-top">
          <a href="/" class="brand brand-invert footer-logo" aria-label="MiraiWay ホーム">
            <LogoMark width={92} height={75} invert={true} idPrefix="footer" />
          </a>
        ...
        <div class="footer-main">
          <div class="footer-brand">
            <p class="footer-kicker">CONNECTING PEOPLE, SHAPING FUTURES</p>
        ...
        <div class="footer-wordmark" aria-hidden="true">MiraiWay</div>
      </div>
    </footer>
  )
}
